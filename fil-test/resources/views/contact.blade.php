<x-layout>
    ...
    <div class="mt-2 text-lg text-gray-600 text-left">Accelerate your inquiries and let’s drive your automotive aspirations forward with precision.
    <form action="#" method="POST" class="mx-0 mt-16 max-w-full sm:mt-8">
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div class="flex gap-x-4 col-span-full">
